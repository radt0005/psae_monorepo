...
6. **Calls handler** -- invokes your function with the merged argument object
7. **Writes outputs** -- inspects the return value and copies files to `outputs/`
