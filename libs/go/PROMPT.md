...
This folder contains the implementation of the Go library for the spade system. The specifications for the system are located in `../../spec/`.  Please consult these to have a thorough understanding of the system.

Your task is to create a detailed implementation plan for the Go library based on the specifications in `../../spec/`.  Please format the implementation plan as a markdown checklist.  

After the completion of the implementation plan, this folder should contain a working go library with tests.  
