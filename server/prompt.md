...
Your task is to create a detailed implementation plan for the scheduling server based on the specifications in `../spec/`.  Please format the implementation plan as a markdown checklist.  

After the completion of the implementation plan, this folder should contain a working scheduling server with tests.  
...
This system should be written in Go.  The core library has scheduling primatives in `../core`, and the task runner has a reference implementation in `../runner`. 
